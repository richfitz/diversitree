## Something different needed for cvodes; see asr.R:make.do.asr.marginal
...
make.asr.marginal.bisse.t2 <- make.asr.marginal.dtlik.t
make.asr.marginal.musse.t2 <- make.asr.marginal.dtlik.t
