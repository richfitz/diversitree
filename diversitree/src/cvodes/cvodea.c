...
int CVodeB(void *cvode_mem, realtype tBout, int itaskB)
{
  ...
  CkpntMem ck_mem;
  /* RGF: Added initial value for flag to avoid compiler warning */
  int sign, flag=-1;
                          ...
                          N_Vector y, N_Vector *yS)
{
  ...
  /* RGF: It seems that ySd0 and yS0 might be used unitialised here,
     but presumably this is not the case */
