...
\caption{Phylogenetic tree of the 350 species of
    ...
    tips; gray=sexually dimorphic, black=sexually monomorphic, and
    white=no data.  For unresolved clades, the colour is scaled to
    indicate the proportion of species in each state.  For clarity,
    only family or subfamily names are shown.}
