...
library(cacheSweave)
## Remove stars, as they don't look nice when typeset.  Also set the
## prompt to be two spaces, which we later gobble.
if ( !interactive() )
  options(show.signif.stars=FALSE, prompt="  ", continue="  ")
@ 
